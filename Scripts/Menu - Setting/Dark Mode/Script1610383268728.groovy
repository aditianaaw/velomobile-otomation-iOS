...
Mobile.tap(findTestObject('Object Repository/Velocity Mobile/XCUIElementTypeButton - ic toggle off'), 0)

Mobile.tap(findTestObject('Object Repository/Velocity Mobile/XCUIElementTypeButton - ic toggle on'), 0)
