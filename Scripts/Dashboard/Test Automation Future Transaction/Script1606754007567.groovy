...
Mobile.scrollToText('FUTURE TRANSACTIONS')

Mobile.tap(findTestObject('Object Repository/Velocity Mobile/XCUIElementTypeButton - VIEW ALL'), 0)

Mobile.tap(findTestObject('Object Repository/Velocity Mobile/XCUIElementTypeStaticText - Next 7 Days'), 0)

Mobile.delay(5)

Mobile.tap(findTestObject('Object Repository/Velocity Mobile/XCUIElementTypeImage (13)'), 0)

Mobile.delay(5)

Mobile.tap(findTestObject('Object Repository/Velocity Mobile/XCUIElementTypeButton (5)'), 0)

Mobile.delay(10)

Mobile.tap(findTestObject('Velocity Mobile/XCUIElementTypeWindow (1)'), 0)

//Mobile.tap(findTestObject('Object Repository/Velocity Mobile/XCUIElementTypeOther (8)'), 0)
//Mobile.tap(findTestObject('Object Repository/Velocity Mobile/XCUIElementTypeStaticText - Monday, 30 Nov 2020 113901 (1)'),
//	0)
