...
<MobileElementEntity>
   ...
   <name>XCUIElementTypeStaticText - I want to SELL (1)</name>
   <tag></tag>
   ...
   <locator>**/XCUIElementTypeStaticText[`enabled == 1 AND label == 'I want to SELL' AND name == 'I want to SELL' AND value == 'I want to SELL'`]</locator>
